<template>
  <v-form v-model="valid">
    <v-layout wrap>
      <v-flex xs12 sm1>
          <v-subheader v-text="'Cedula'"></v-subheader>
      </v-flex>
      <v-flex xs12 sm2>
        <v-select
    ...
    <v-layout wrap>
      <v-flex xs12 sm1>
          <v-subheader v-text="'Placa'"></v-subheader>
      </v-flex>
      <v-flex xs12 sm2>
        <v-select
          v-bind:items="placas"
